...
write.csv(coda_df, paste(output, "codadict", sep="/"), row.names = FALSE, fileEncoding = "UTF-8")
write.csv(onset_df, paste(output, "onsetdict", sep="/"), row.names = FALSE, fileEncoding = "UTF-8")